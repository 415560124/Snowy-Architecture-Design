...
public class SnowyAApp {
    ...
    public static void main(String[] args) {
        SpringApplication springApplication = new SpringApplication(SnowyAApp.class);
        springApplication.run(args);
        log.info(">>> {}", SnowyAApp.class.getSimpleName().toUpperCase() + " STARTING SUCCESS");
    }
